...
//int App::DeskWidth = 1280;
//int App::DeskHeight = 720;
int App::DeskWidth = 1024;
int App::DeskHeight = 768;

QString App::ip="http://jiu.veiding.com";
QString App::port="8080";
QString App::macId="mk123456";

QString App::user="admid";
QString App::password="mk123456";

QString App::card="";
QString App::cardName="";
QString App::cardIntegration="";
...
int App::selectDeviceNum=5;
int App::selectGoodsNum_page=16;
int App::selectDevice_GoodsNum=80;

int App::compensate[6]= {0};

QString App::replenishmentQrcode="";
QString App::replenishmentGoodsName="";
int App::replenishmentTotalNum=-1;
