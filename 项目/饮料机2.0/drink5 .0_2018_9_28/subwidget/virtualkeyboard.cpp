...
#define  KEY_INTERVAL_COL_WIDTH           5
#define  KEY_INTERVAL_ROW_HEIGHT          5
#define  KEY_TOP_MARGIN                   0
#define  KEY_LEFT_MARGIN                  0
//#define  SPECIAL_ROW_OFFSET               0

#include "configure/app.h"

VirtualKeyboard::VirtualKeyboard(QWidget *parent) : BaseSubWidget(parent)//, Qt::Tool | Qt::WindowStaysOnTopHint | Qt::FramelessWindowHint
{
    this->setFixedSize(App::screenWidget-100,App::screenHeight/5.0);
    this->setObjectName("VirtualKeyboard");
    ...
    if (pFocusWidget != NULL)
    {
        switch (i)
        {
            case KEY_RETURN:{//退出
                ...
                QKeyEvent keyRelease(QEvent::KeyRelease, Qt::Key_Delete, Qt::NoModifier, QString());
...
void VirtualKeyboard::updateKeyText()
{
    ...
    ppbKey[KEY_RETURN]->setText("Delete");
}
